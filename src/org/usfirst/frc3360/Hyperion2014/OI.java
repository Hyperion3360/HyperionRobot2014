...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        Button_CanonShooter_Shoot = new JoystickButton(driverRightJoystick, 1);
        Button_CanonShooter_Shoot.whenPressed(new CanonShooter_Shoot());
        
        Button_CanonSpinner_TopGoal = new JoystickButton(driverLeftJoystick, 4);
        Button_CanonSpinner_TopGoal.whileHeld(new CanonSpinner_PrepareTopGoal());
        
        Button_CanonSpinner_LowSpeed = new JoystickButton(driverLeftJoystick, 5);
