...
public class OI {
    ...
    public JoystickButton startVisionTrackingPeriodic;
    public JoystickButton startVisionTrackingOnDemand;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        stopVisionTracking.whenReleased(new Vision_SetMode(Vision.ms_CAMERA_MODE_HUMAN));
        startVisionTrackingPeriodic = new JoystickButton(driverLeftJoystick, 2);
        startVisionTrackingPeriodic.whenReleased(new Vision_SetMode(Vision.ms_CAMERA_MODE_VISION_TRACKING));
        startVisionTrackingOnDemand = new JoystickButton(driverLeftJoystick, 2);
        startVisionTrackingOnDemand.whenReleased(new Vision_SetMode(Vision.ms_CAMERA_MODE_VISION_TRACKING,
                                                                    Vision.ms_CAMERA_CAPTURE_MODE_DEMAND));
