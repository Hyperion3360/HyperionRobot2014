...
import org.usfirst.frc3360.Hyperion2014.commands.CanonSpinner_PreparePass;
...
public class OI {
    ...
    public JoystickButton Button_CanonSpinner_TopGoal;
    public JoystickButton Button_CanonSpinner_LowSpeed;
    public JoystickButton Button_CanonSpinner_CatchSpeed;
    public JoystickButton Button_CanonAngle_AngleGoDown;
    public JoystickButton Button_CanonAngle_AngleGoUp;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        Button_CanonShooter_Shoot = new JoystickButton(driverLeftJoystick, 1);
        Button_CanonShooter_Shoot.whenPressed(new CanonShooter_Shoot());
        
        Button_CanonSpinner_TopGoal = new JoystickButton(driverRightJoystick, 1);
        Button_CanonSpinner_TopGoal.whileHeld(new CanonSpinner_PrepareTopGoal());
        
        Button_CanonSpinner_LowSpeed = new JoystickButton(driverLeftJoystick, 3);
        Button_CanonSpinner_LowSpeed.whileHeld(new CanonSpinner_PreparePass());
        
        Button_CanonSpinner_CatchSpeed = new JoystickButton(driverLeftJoystick, 2);
        Button_CanonSpinner_CatchSpeed.whileHeld(new CanonSpinner_ReceivePass());
        
        Button_CanonAngle_AngleGoDown = new JoystickButton(driverRightJoystick, 2);
        Button_CanonAngle_AngleGoDown.whileHeld(new CanonAngle_SetShooterAngle2());
        
        Button_CanonAngle_AngleGoUp = new JoystickButton(driverRightJoystick, 3);
        Button_CanonAngle_AngleGoUp.whileHeld(new CanonAngle_SetShooterAngle());
