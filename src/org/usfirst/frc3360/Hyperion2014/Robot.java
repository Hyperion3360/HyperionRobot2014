...
public class Robot extends IterativeRobot {
    ...
    public static CanonSpinnerSafety canonSpinnerSafety;
    public static CanonShooter canonShooter;
    public static DriveTrain driveTrain;
    public static SpinnerSetter SpinnerSetter;
	...
	RobotMap.init();
        ...
        canonSpinnerSafety = new CanonSpinnerSafety();
        canonShooter = new CanonShooter();
        driveTrain = new DriveTrain();
        SpinnerSetter = new SpinnerSetter();
        vision = new Vision(Vision.ms_CAMERA_MODE_VISION_TRACKING,
                            Vision.ms_DISTANCE_MODE_CAMERA,
                            Vision.ms_CAMERA_CAPTURE_MODE_PERIODIC);
