...
public class Vision extends Subsystem implements Runnable{
    ...
    public synchronized void runDistance(){
    ...
    boolean getCameraInfoHot() {
        ...
        try {
            ...
            if (filteredImage.getNumberParticles() > 0) {
                ...
                if (verticalTargetCount > 0) {
                    ...
                    SmartDashboard.putNumber("DistanceCamera", distance);
        ...
        SmartDashboard.putBoolean("HotTargetDetected", m_bIsHotTarget);
        return m_bIsHotTarget;
    }
    
        double getCameraInfoDistance() {
        TargetReport target = new TargetReport();
        int verticalTargets[] = new int[MAX_PARTICLES];
        int horizontalTargets[] = new int[MAX_PARTICLES];
        int verticalTargetCount, horizontalTargetCount;
