...
public class Vision extends Subsystem
{
    ...
    AxisCamera camera = RobotMap.m_camera; // the axis camera object (connected to the switch)
    

    CriteriaCollection cc = RobotMap.cc;      // the criteria for doing the particle filter operation
    ...
    public double GetDistanceCamera(){
    ...
    TargetReport target = new TargetReport();
        ...
        cc.addCriteria(NIVision.MeasurementType.IMAQ_MT_AREA, AREA_MINIMUM, 65535, false);
                ...
                try {
                    ...
                    BinaryImage thresholdImage = image.thresholdHSV(20, 140, 20, 255, 20, 175);   // keep only green objects
                ...
                SmartDashboard.putNumber("Distance Camera in feet", distance);
                return distance; 
